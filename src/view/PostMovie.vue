    ...
    <div class="hero sr-single-hero sr-single">
      <div class="container">
          <div class="row">
              <div class="col-md-12">
                  <ul class="breadcumb">
                      <li @click="handlerClickPostMovie()" class="active"><a href="#">Thêm Phim Mới</a></li>
                      <li style="margin-left: 20px;" @click="handlerClickListMovie()" > <a style="cursor: pointer" class="ion-ios-arrow-right">Danh Sách Phim</a></li>
                  </ul>
              </div>
          </div>
      </div>
        ...
        <div class="container" style="padding-top: 64px; padding-bottom: 64px;">
          <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
              <h5 v-if="!status_update"></h5>
              <h5 v-else>Trang Cập Nhật Phim</h5>
                <form>
                  ...
                  <div class="form-group">
                      ...
                      <span v-if="statusError.category" class="text-danger">*Vui lòng nhập thể loại phim*</span>
                  </div>
                  <div class="form-group">
